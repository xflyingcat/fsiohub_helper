...
class loggerDialog: public wxDialog
{
    ...
    //private:
        ...
        void OnButton10Click3(wxCommandEvent& event);
        void OnButton12Click1(wxCommandEvent& event);
        void OnButton13Click1(wxCommandEvent& event);
        void OnButton14Click1(wxCommandEvent& event);
        void OnButton34Click(wxCommandEvent& event);
        void OnButton11Click(wxCommandEvent& event);
        void OnButton35Click(wxCommandEvent& event);
        void OnButton36Click(wxCommandEvent& event);
        //*)
